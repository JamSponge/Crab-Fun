...
if EnemyType = 1
    ...
    var EnemyDeathSpeed = global.RealGame_Speed*2
    var EnemyHealth = 1
    var EnemyScale = random_range(0.3,0.6)
    var EnemyWeight = EnemyScale*3
    var EnemySpeed = 300/global.RealGame_Speed
    var EnemyMaxSpeed = 600/global.RealGame_Speed
...
if EnemyType = 2
    ...
    var EnemyDeathSpeed = global.RealGame_Speed
    var EnemyHealth = 3
    var EnemyScale = random_range(0.6,0.8)
    var EnemyWeight = EnemyScale*2
    var EnemySpeed = 350/global.RealGame_Speed
    var EnemyMaxSpeed = 700/global.RealGame_Speed
